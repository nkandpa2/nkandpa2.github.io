...
### Audio Samples
Below, we share samples generated by the models we evaluate in the paper: Mel2Mel + Diffwave, Mel2Mel + Griffin-Lim, and Demucs.  Each row in the table contains the ground-truth high-quality recording, the simulated low-quality recording, and the reconstruction generated by each model.
